                    ...
                    <div class="widget-summary">
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <div class="info">
                                    <strong class="amount"><?php echo e($buyerCount); ?></strong>
                                </div>
                            </div>
                            <div class="summary-footer">
                    ...
                    <div class="widget-summary">
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <div class="info">
                                    <strong class="amount"><?php echo e($sellerCount); ?></strong>
                                </div>
                            </div>
                            <div class="summary-footer">
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Report','Users']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proacademy\resources\views/admin/report/user.blade.php ENDPATH**/ ?>