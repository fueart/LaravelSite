    ...
    <div class="card card-primary">
        <div class="card-body">
            <form method="post" action="/admin/setting/store">
                ...
                <div class="form-group">
                    <div class="h-15"></div>
                    <input type="submit" value="Enregistrer les modifications" class="btn btn-primary pull-left">
                </div>
            </form>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <th class="text-center">
                            <?php if(!empty($list->position) and in_array($list->position, array_flip(\App\Models\AdsBox::$positions))): ?>
                                <?php echo e(trans('admin.'.\App\Models\AdsBox::$positions[$list->position])); ?>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Advertising','Banners']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proacademy\resources\views/admin/ads/boxs.blade.php ENDPATH**/ ?>