    ...
    <section class="card">
        <div class="card-body">
            <table class="table table-bordered table-striped mb-none" id="datatable-details">
                <thead>
                <tr>
                    <th class="text-center"><?php echo e(trans('admin.th_titre')); ?></th>
                    <th class="text-center"><?php echo e(trans('admin.description')); ?></th>
                    <th class="text-center" width="100"><?php echo e(trans('admin.prix')); ?></th>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Advertising','Plans']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proacademy\resources\views/admin/ads/list.blade.php ENDPATH**/ ?>