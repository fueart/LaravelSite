...
<div class="modal fade modal-dialog-s" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-s">
        <div class="modal-content">
            <div class="modal-header">
                <?php echo e(trans('main.alert')); ?>

            </div>
            <div class="modal-body">
                <?php echo e(trans('main.are_you_sure')); ?>
...
<?php /**PATH C:\laragon\www\proacademy\resources\views/web/default/user/layout/modals.blade.php ENDPATH**/ ?>