            ...
            <table class="table table-bordered table-striped mb-none" id="datatable-details">
                ...
                <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="text-center"><?php echo e(count($item->comments)); ?></td>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Blog','Posts']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proacademy\resources\views/admin/blog/list.blade.php ENDPATH**/ ?>